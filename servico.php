...
<center>
   ...
   <table border="0px" align="center">
										 <tr  width="450px" height="100px">
										<td rowspan="3" >
                              			<img src="imgs/botijao.jpg" width="450px" height="500px"/>
										</td>

										<td height="100px">
                                        <h3>DESCRIÇÃO DO PRODUTO:</h3>
                                        
                                      <h4>Botijão de 13 KG da NacionalGás,
                                         Dimensões: diâmetro 360 mm x altura 475mm.</h4>
		                              
										</td>
                                        
                                        <tr>
                                          <td><h3>QUANTIDADE: <input id="txt_qtd_1" type="number" onChange="MudaLabeL('compl_Preco_1',this.value)" max="5" min="1" value="1" ></button><h3></td>
                                                 
                                        </tr>
                                        
                                        <tr>
										   <td><h3>PREÇO: <label id="compl_Preco_1" class="negrito">R$ 60,00</label><h3></td>
                                        </tr>
